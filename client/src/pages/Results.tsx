...
const downloadResultAsPDF = (result: any, student: any) => {
  ...
  img.onload = function() {
    ...
    doc.text("ROBERTSON EDUCATION", stampCenterX, stampCenterY - 12, { align: "center" });
    ...
    doc.text(`${new Date().toLocaleDateString('en-GB')} • REG: 7779525`, stampCenterX, stampCenterY + 25, { align: "center" });
                ...
                {resultData && (
                  <div className="space-y-6">
                    ...
                    <div id="result-print-content" className="result-container" style={{ display: 'none' }}>
                      ...
                      <div className="seal-section" style="text-align: center; margin: 15px auto 25px auto; padding: 10px; border: 1px solid #ccc; display: flex; flex-direction: column; align-items: center; justify-content: center; width: fit-content; max-width: 180px; page-break-inside: avoid; break-inside: avoid;">
                        <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                          ...
                          <div style="font-size: 7pt; color: #666; text-align: center; margin: 0;">Date: {new Date().toLocaleDateString('en-GB')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
